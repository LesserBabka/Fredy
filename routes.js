...
//
  app.get("/", function(req, res) {
    res.send("<h1>REST API</h1><p><form method=POST action='/update'><input name='username'><input name='data'><button type=submit>submit</button></form><p>Oh, hi! There's not much to see here - view the code instead</p><script src=\"https://button.glitch.me/button.js\" data-style=\"glitch\"></script><div class=\"glitchButton\" style=\"position:fixed;top:20px;right:20px;\"></div>");
...
//
  app.post("/update", function(req, res) {
    if(!req.body.username || !req.body.data) {
      console.log("Received incomplete POST: "+JSON.stringify(req.body, undefined, 2));
